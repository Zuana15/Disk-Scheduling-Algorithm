...
For a detailed breakdown of the algorithmic challenges faced during development (specifically handling disk boundary conditions in SCAN/C-SCAN), please view the report here: Technical Report.pdf
